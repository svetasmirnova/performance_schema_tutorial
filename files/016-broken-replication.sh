...
/usr/bin/clear
tmux new-session -d -n master /home/vagrant/tutorial/run_command_with_hint.sh "$HINT" m --prompt='mysql> ' -t test
tmux new-window -n slave /home/vagrant/tutorial/run_command_with_hint.sh "$HINT" s1 --prompt='mysql> ' -t test
tmux attach
cleanup
