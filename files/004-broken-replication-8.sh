#!/bin/bash
DESCRIPTION="Find an error and fix replication, MySQL 8.0"
...
source /home/vagrant/tutorial/common-replication-m8.sh
m test < /home/vagrant/tutorial/002-broken-replication.setup.master.sql
s1 test < /home/vagrant/tutorial/002-broken-replication.setup.slave.sql
/usr/bin/clear
echo -e $HINT
sleep 5
